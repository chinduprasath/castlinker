          ...
          <div className="bg-card-gradient border border-gold/10 rounded-xl p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
              <div className="text-center">
                ...
                <p className="text-foreground/70">From actors to cinematographers</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-foreground/70">Films, series, and commercials</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-foreground/70">Global talent network</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-card-gradient border border-gold/10 rounded-xl p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex items-start gap-4">
                <div className="h-16 w-16 rounded-full bg-cinematic-dark border border-gold/20 flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-foreground/70 text-sm">Former casting director with 15+ years of experience in major studios.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-foreground/70 text-sm">Tech entrepreneur with a background in AI and machine learning.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-foreground/70 text-sm">Former talent agent who has represented A-list actors.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-foreground/70 text-sm">UX specialist with a passion for creating intuitive interfaces.</p>
                </div>
              </div>
            </div>
          </div>
